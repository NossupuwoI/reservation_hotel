                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-group" action="/role/traitement" method="POST">
                                                        @csrf
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="numbre" class="form-control" name="designation" required>
                                                        </div>
                                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="/updaterole/{{ $role->id }}" class="btn btn-primary">
        ...
        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4>Voulez-vous vraiment le role ?
                        </h4>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>

                        <a href="/delete-role/{{ $role->id }}" class="btn btn-danger">Supprimer
                        </a>
