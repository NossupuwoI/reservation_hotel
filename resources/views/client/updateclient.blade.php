        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <div class="body-form ">
                            <form class="form-group" action="/updateCli/traitement"
                            method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="number" class="form-control" name="id" value="{{ $clients->id }}" style="display: none"
                                    required>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Id
                                    Employer</label>
                                <input type="number" class="form-control" name="User" value="{{ $clients->User }}"
                                    required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" name="mdp" value="{{ $clients->mdp }}"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Date de naissance
                                    </label>
                                <input type="date" class="form-control" name="date_naiss" value="{{ $clients->date_naiss }}"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Telephone
                                    </label>
                                <input type="number" class="form-control" name="telephone" value="{{ $clients->telephone }}"
                                    required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" name="photo" value="{{ $clients->photo }}"
                                    required>
                            </div>
