                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-group" action="service/traitement"
                                                        method="POST">
                                                        @csrf
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="numbre" class="form-control" name="prix"
                                                                required>
                                                        </div>
                                                </div>
            ...
            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <h4>Voulez-vous vraiment supprimer ce service de chambre ?
                            </h4>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
                            <a href="/delete-service/{{ $service->id }}" class="btn btn-danger">Supprimer
                            </a>
                        </div>
                    </div>
                </div>
